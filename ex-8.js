...
// Value ใน article ต้องเกิดจากการต่อ Paragraph ทั้ง 3 Paragraph (firstParagraph, secondParagraph, thirdParagraph) ด้วยวิธี String Concatenation และขึ้นบรรทัดใหม่ให้กับ Paragraph ที่นำมาต่อในทุกๆ ครั้ง
